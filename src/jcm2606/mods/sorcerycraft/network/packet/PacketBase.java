package jcm2606.mods.sorcerycraft.network.packet;
...
public abstract class PacketBase {
    public static String CHANNEL = Packets.CHANNEL_CORE;
    ...
    static {
        ...
        // Add packets here using:
        // builder.put(Integer.valueOf(<id>), <packetclassname>.class);
        
        idMap = builder.build();
    }
    
    public static PacketBase constructPacket(int packetId) throws ProtocolException, ReflectiveOperationException {
        Class<? extends PacketBase> clas = idMap.get(Integer.valueOf(packetId));
        if (clas == null) {
