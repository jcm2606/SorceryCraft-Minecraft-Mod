...
public class CrystalRender extends TileEntitySpecialRenderer {
	...
	public void renderAModelAt(TileEntityCrystal tile, double d,
		...
		RenderUtil.getInstance().setBrightness(tile.worldObj, tile.xCoord, tile.yCoord, tile.zCoord, tile.blockType, tile.blockType.getMixedBrightnessForBlock(tile.worldObj, tile.xCoord, tile.yCoord, tile.zCoord));
		bindTextureByName(Reference.PATH_TEXTURES_BLOCKS + "crystal.png"); // texture
