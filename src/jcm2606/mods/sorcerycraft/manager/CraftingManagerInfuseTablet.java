...
public class CraftingManagerInfuseTablet {
	/** The static instance of this class */
	private static final CraftingManagerInfuseTablet instance = new CraftingManagerInfuseTablet();
	 ...
	 */
	public static final CraftingManagerInfuseTablet getInstance() {
		return instance;
	}

	public CraftingManagerInfuseTablet() {
		// Place recipes here
	 ...
	 */
	public static void addRecipe(ItemStack par1ItemStack,
		...
		recipes.add(new ShapedRecipes(var5, var6, var15, par1ItemStack));
	}

	public static void addShapelessRecipe(ItemStack par1ItemStack,
			Object... par2ArrayOfObj) {
