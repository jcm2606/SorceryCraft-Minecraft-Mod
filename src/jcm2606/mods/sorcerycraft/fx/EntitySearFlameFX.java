...
public class EntitySearFlameFX extends EntityFXJC
{
    float particleScaleOverTime;
    public int maxAge = 80;

    public EntitySearFlameFX(World par1World, double f, double f2, double f4, double par8, double par10, double par12)
    {
