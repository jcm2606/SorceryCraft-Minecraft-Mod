                    ...
                    if (item != null && item == stack && item.getItemDamage() <= item.getMaxDamage())
                    {
                        if (GeneralUtil.isClient())
                        {
                            if (player.inventory.hasItem(SCObjects.astralCellEnergy.itemID))
                            {
                                                        ...
                                                        if (stack2.getItem() == SCObjects.astralCellEnergy)
                                                        {
                                                            ...
                                                            if (cell.getEnergy(stack2) < 999)
                                                            {
                                                                ...
                                                                for (int k = 0; k < 4; k++)
                                                                {
                                                                    ...
                                                                    world.spawnParticle("smoke", player.posX + (world.rand.nextGaussian() / l),
                                                                            player.posY - 1.5, player.posZ + (world.rand.nextGaussian() / l), 0.0f,
                                                                            0.05f, 0.0f);
                                                                    world.spawnParticle("smoke", player.posX - (world.rand.nextGaussian() / l),
                                                                            player.posY - 1.5, player.posZ - (world.rand.nextGaussian() / l), 0.0f,
                                                                            0.05f, 0.0f);
                                ...
                                if (player.fallDistance != 0.0f && !Keyboard
                                        .isKeyDown(FMLClientHandler.instance().getClient().gameSettings.keyBindJump.keyCode))
                                {
                                    int k = 4;
                                    
                                    world.spawnParticle("smoke", player.posX + (world.rand.nextGaussian() / k), player.posY + (world.rand
                                            .nextGaussian() / 2), player.posZ + (world.rand.nextGaussian() / k), 0.0f, 0.0f, 0.0f);
                                    world.spawnParticle("smoke", player.posX - (world.rand.nextGaussian() / k), player.posY - (world.rand
                                            .nextGaussian() / 2), player.posZ - (world.rand.nextGaussian() / k), 0.0f, 0.0f, 0.0f);
                                }
