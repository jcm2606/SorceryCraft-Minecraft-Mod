...
{
    public static void drawAstralParticleField(TileEntity te, double par2, double par4, double par6, float f, String textureNorth,
            String textureSouth, String textureEast, String textureWest, String textureTop, String textureBottom)
    {
        ...
        renderUnitBoxWithUV(te, (float) par2, (float) par4, (float) par6, t, 0, 0, 1, 1, textureNorth, textureSouth, textureEast, textureWest,
    ...
    public static void drawAstralParticleFieldStationary(double par2, double par4, double par6, float f, String textureNorth, String textureSouth,
            String textureEast, String textureWest, String textureTop, String textureBottom)
    {
        float var9 = (float) Minecraft.getMinecraft().thePlayer.posX;
        float var10 = (float) Minecraft.getMinecraft().thePlayer.posY;
        float var11 = (float) Minecraft.getMinecraft().thePlayer.posZ;
        ...
        Tessellator t = Tessellator.instance;
        renderUnitBoxWithUV(null, (float) par2, (float) par4, (float) par6, t, 0, 0, 1, 1, textureNorth, textureSouth, textureEast, textureWest,
                textureTop, textureBottom);
    ...
    private static void renderUnitBoxWithUV(TileEntity te, float paramFloat1, float paramFloat2, float paramFloat3, Tessellator paramTessellator,
            float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, String texture)
    {
        renderUnitBoxWithUV(te, paramFloat1, paramFloat2, paramFloat3, paramTessellator, paramFloat4, paramFloat5, paramFloat6, paramFloat7, texture,
                texture, texture, texture, texture, texture);
    }
    
    private static void renderUnitBoxWithUV(TileEntity te, float paramFloat1, float paramFloat2, float paramFloat3, Tessellator paramTessellator,
            float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, String textureNorth, String textureSouth, String textureEast,
            String textureWest, String textureTop, String textureBottom)
    {
        // North
