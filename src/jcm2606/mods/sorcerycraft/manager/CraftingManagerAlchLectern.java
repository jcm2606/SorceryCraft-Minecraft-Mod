...
public class CraftingManagerAlchLectern {
	/** The static instance of this class */
	private static CraftingManagerAlchLectern instance = new CraftingManagerAlchLectern();
	 ...
	 */
	public static CraftingManagerAlchLectern getInstance() {
		return instance;
	}

	private CraftingManagerAlchLectern() {
/*		for(int i = 0; i < vanillaManager.getInstance().getRecipeList().size(); i++)
		{
			this.recipes.add(vanillaManager.getInstance().getRecipeList().get(i));
		}*/
	}
