...
public class ToolHandler
{
     ...
     * 
     * @param stack
     *            The item performing the block working
     * @param player
     *            The player performing the block working
     * @param world
     *            The world the block working is being performed in
     * @param x
     *            The X coord the block working is being performed at
     * @param y
     *            The X coord the block working is being performed at
     * @param z
     *            The X coord the block working is being performed at
    ...
    public static void performBlockWorking(ItemStack stack, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        // world.playSoundAtEntity(player, "sorcerycraft.magic_fail", 1.0f,
        // 1.0f);
    }
}
