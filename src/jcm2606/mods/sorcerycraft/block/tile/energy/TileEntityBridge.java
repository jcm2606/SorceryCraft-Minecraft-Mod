...
public class TileEntityBridge extends TileEntityJC implements IEnergyBridge {
    ...
    public void setConnectedBlockType(Coord coord)
    {
        if(this.worldObj.getBlockId((int) coord.x, (int) coord.y, (int) coord.z) != 0)
        {
            ...
            {
                if(this.worldObj.getBlockTileEntity((int) coord.x, (int) coord.y, (int) coord.z) instanceof IEnergyCreator)
                {
                    this.connectedBlockType = this.CONNECTED_BLOCK_TYPE_CREATOR;
                }
    ...
    public void updateEntity() {
        ...
        {
            TileEntityBridge bridge = (TileEntityBridge) connectedTE;
