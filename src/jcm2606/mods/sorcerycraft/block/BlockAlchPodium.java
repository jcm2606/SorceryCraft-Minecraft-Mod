...
public class BlockAlchPodium extends SCBlockContainer {
	public BlockAlchPodium(int par1, Material par2Material) {
		super(par1, par2Material, "alchPodium", Rarities.BASIC);
	...
	public TileEntity createNewTileEntity(World var1) {
		return new TileEntityAlchPodium();
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3,
		...
		par5EntityPlayer.openGui(SorceryCraft.instance,
				GuiIDs.ALCH_LECTERN, par1World, par2, par3, par4);
		return true;
	}
}
