...
public class ItemPsyonicEnergyCell extends SCItem
{
    public final String NBT_ENERGY = "energy";
    
    public ItemPsyonicEnergyCell(int par1)
    {
    ...
    {
        NBTHelper.setInt(NBTHelper.getNBTCompoundForItemStack(stack), this.NBT_ENERGY, energy);
    }
    ...
    public int getEnergy(ItemStack stack)
    {
        ...
        if (tag.hasKey(this.NBT_ENERGY))
        {
            energy = tag.getInteger(this.NBT_ENERGY);
        } else
        {
            energy = 1000;
        }
    ...
    {
        list.add("Storing " + this.getEnergy(stack) + " Psy");
    }
    ...
    {
        ItemStack stack = new ItemStack(SCObjects.psyonicCellEnergy, 1, 0);
        this.setEnergy(stack, 1000);
        list.add(stack);
        
        ItemStack stack2 = new ItemStack(SCObjects.psyonicCellEnergy, 1, 1000);
