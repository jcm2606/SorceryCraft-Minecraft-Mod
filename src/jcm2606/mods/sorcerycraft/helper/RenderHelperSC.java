...
public class RenderHelperSC {
    public static void drawAstralParticleField(TileEntity te, double par2, double par4, double par6, float f, String textureSheet)
    {
        ...
        for (int var14 = 0; var14 < 16; ++var14)
        {
            ...
            if (var14 == 0)
            {
                RenderUtil.renderEngine.bindTexture("/misc/tunnel.png");
                var17 = 0.1F;
                var15 = 65.0F;
                var16 = 0.125F;
            ...
            if (var14 == 1)
            {
                RenderUtil.renderEngine.bindTexture("/misc/particlefield.png");
                GL11.glEnable(GL11.GL_BLEND);
        ...
        RenderUtil.renderEngine.bindTexture(textureSheet);
