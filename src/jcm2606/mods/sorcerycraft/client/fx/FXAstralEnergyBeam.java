...
public class FXAstralEnergyBeam extends FXSC
{
    ...
    public FXAstralEnergyBeam(World world, double f, double f2, double f3, double d, double d2, double d3, int par4)
    {
    ...
    public void renderParticle(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        RenderHandlerSC.bindTexture(Reference.SPRITE_ASTRAL_BEAM);
