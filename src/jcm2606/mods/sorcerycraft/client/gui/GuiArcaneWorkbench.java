...
{
    public GuiArcaneWorkbench(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
        super(new ContainerArcaneWorkbench(par1InventoryPlayer, par2World, par3, par4, par5));
    }
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("\2478\247oArcane Workbench"), 6, 6, 0xA74AC7);
    }
