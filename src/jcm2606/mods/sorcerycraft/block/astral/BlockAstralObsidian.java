...
public class BlockAstralObsidian extends BlockAstral
{
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
         ...
         * double vx = par2 - px + par5Random.nextFloat() / 2.0F; double vy =
         * par3 - py + par5Random.nextFloat() / 2.0F; double vz = par4 - pz +
         * par5Random.nextFloat() / 2.0F; SCParticle.spawnParticle("astralRune",
         * px, py, pz, vx, vy, vz);
         */
    }
