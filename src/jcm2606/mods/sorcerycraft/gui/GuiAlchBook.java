...
public class GuiAlchBook extends GuiContainer {
	...
	public void initGui() {
		...
		int i1 = width / 2;
		int i2 = height / 2;
		this.buttonList.add(new Button(0, i1 - 186, i2 + (146 / 2), 16, 16,
				"\2478<<", "\2470<<", 0x000000, 0x000000));
		this.buttonList.add(new Button(1, i1 + 169, i2 + (146 / 2), 16, 16,
				"\2478>>", "\2470>>", 0x000000, 0x000000));
	}
	...
	public void drawLeftPage() {
		...
		mc.renderEngine.bindTexture(Reference.PATH_TEXTURES_GUI + "/book_alch/book_page_left.png");
		int i1 = width / 2 - 182;
		int i2 = height / 2 - 96;
	...
	public void drawRightPage() {
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		mc.renderEngine.bindTexture(Reference.PATH_TEXTURES_GUI + "/book_alch/book_page_right.png");
		int i1 = width / 2;
		int i2 = height / 2 - 96;
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2,
		...
		fontRenderer.drawString("\2478" + pageNum,
				i1_1 - (fontRenderer.getStringWidth("" + pageNum) + 3), i2_2
						+ (160 / 2), 0xffffff);
		fontRenderer.drawString("\2478" + pageNumRight, i1_1 + 4, i2_2
				+ (160 / 2), 0xffffff);
	}
}