...
public class EntityElementalSlime extends EntityLiving implements IMob
{
    ...
    public EntityElementalSlime(World par1World)
    {
        super(par1World);
    ...
    protected void setSlimeSize(int par1)
    {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(par1 * par1);
    ...
    {
        return new EntityElementalSlime(this.worldObj);
    }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (this.canDamagePlayer())
        {
            ...
            if (this.canEntityBeSeen(par1EntityPlayer) && this.getDistanceSqToEntity(par1EntityPlayer) < 0.6D * i * 0.6D * i && par1EntityPlayer
    ...
    public boolean getCanSpawnHere()
    {
        ...
        } else
        {
            if (this.getSlimeSize() == 1 || this.worldObj.difficultySetting > 0)
            {
                ...
                if (biomegenbase == BiomeGenBase.swampland && this.posY > 50.0D && this.posY < 70.0D && this.rand.nextFloat() < 0.5F && this.rand
                        .nextFloat() < this.worldObj.func_130001_d() && this.worldObj.getBlockLightValue(MathHelper.floor_double(this.posX),
                        MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)) <= this.rand.nextInt(8))
                {
