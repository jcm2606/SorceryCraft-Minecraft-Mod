...
public class RenderElementalSlime extends RenderLiving
{
    private final ModelBase scaleAmount;
    
    public RenderElementalSlime(ModelBase par1ModelBase, ModelBase par2ModelBase, float par3)
    {
    ...
    {
        return ConvertUtil.getResourceLocation("SorceryCraft", "textures/entity/elementalSlime.png");
    }
