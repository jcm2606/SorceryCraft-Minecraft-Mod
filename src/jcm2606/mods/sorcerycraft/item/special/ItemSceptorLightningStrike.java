...
public class ItemSceptorLightningStrike extends SCItemShine {
    public ItemSceptorLightningStrike(int par1) {
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player)
    {
        if(!Keyboard.isKeyDown(Keyboard.KEY_LCONTROL))
        {
            ...
            CompatContainerSC.postUpdateToSubContainers(HandlerMethodID.SCEPTOR_LIGHTNING_USE, null);
        } else {
