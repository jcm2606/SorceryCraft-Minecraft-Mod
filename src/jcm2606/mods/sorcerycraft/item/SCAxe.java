...
public class SCAxe extends SCTool
{
    ...
    public SCAxe(int par1, EnumToolMaterial par2EnumToolMaterial, String par3)
    {
        super(par1, 3, par2EnumToolMaterial, blocksEffectiveAgainst, par3);
    }
