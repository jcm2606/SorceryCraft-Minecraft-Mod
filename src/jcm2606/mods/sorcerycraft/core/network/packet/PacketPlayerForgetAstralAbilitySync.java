...
public class PacketPlayerForgetAstralAbilitySync extends PacketBase
{
    public PacketPlayerForgetAstralAbilitySync()
    {
        super(PacketType.SYNC_PLAYER_ABILITY_LEARN, false);
    }
    
    public PacketPlayerForgetAstralAbilitySync(String name)
    {
        super(PacketType.SYNC_PLAYER_ABILITY_LEARN, false);
    ...
    public void execute(INetworkManager network, Player player)
    {
        ...
        base.list.remove(base.getAbility(name));
    }
}
