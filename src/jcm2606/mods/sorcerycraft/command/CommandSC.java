...
public class CommandSC extends CommandBase {
    ...
    public List addTabCompletionOptions(ICommandSender commandSender, String[] args) {
        switch (args.length) {
            case 1 : {
                return getListOfStringsMatchingLastWord(args, new String[] { Commands.COMMAND_VERSION, Commands.COMMAND_CHARM_CURSE, Commands.COMMAND_CREDITS });
            }
            
            case 2 : {
                if(args[0].equals(Commands.COMMAND_CHARM_CURSE))
                {
                    return getListOfStringsMatchingLastWord(args, new String[] { Commands.COMMAND_CHARM_CURSE_SET, Commands.COMMAND_CHARM_CURSE_REMOVE, Commands.COMMAND_CHARM_CURSE_LIST });
                }
            }
