package jcm2606.mods.sorcerycraft.render.block;
...
public class PodiumRender extends TileEntitySpecialRenderer {

	String texture;
	
	public PodiumRender(String s) {
		aModel = new ModelAlchemicalLectern();
		this.texture = s;
	}

	public void renderAModelAt(TileEntity tile, double d,
		...
		bindTextureByName(Reference.PATH_TEXTURES_BLOCKS + texture); // texture
	...
	private ModelAlchemicalLectern aModel;
}